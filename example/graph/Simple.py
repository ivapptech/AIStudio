...
graph.SetFrameColor(vi.PFillType.FillType_Solid, [vi.MakeColor(190, 223, 208)])
...
plot1.SetLineStyle(vi.PLineType.LineType_Solid)
...
plot2.SetLineStyle(vi.PLineType.LineType_Dot)
...
plot3.SetLineStyle(vi.PLineType.LineType_Dash)
