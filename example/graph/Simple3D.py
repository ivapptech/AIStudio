...
xaxis.ModifyOption( (vi.PAxisOptions.ShowPeerAxisLine | vi.PAxisOptions.ShowPeerTick | vi.PAxisOptions.ShowPeerLabel | vi.PAxisOptions.MinorGrid), True )
...
yaxis.ModifyOption( (vi.PAxisOptions.ShowPeerAxisLine | vi.PAxisOptions.ShowPeerTick | vi.PAxisOptions.ShowPeerLabel | vi.PAxisOptions.MinorGrid), True )
...
zaxis.ModifyOption( (vi.PAxisOptions.ShowPeerAxisLine | vi.PAxisOptions.ShowPeerTick | vi.PAxisOptions.ShowPeerLabel | vi.PAxisOptions.MinorGrid), True )

#Add Annotation
acount = graph.GetAnnotationCount()
for i in range( acount ):
    graph.RemoveAnnotation( "Annotation1" )
Annotation1 = graph.AddAnnotation( "Annotation1" )
...
Annotation1.SetArrowLineStyle( vi.PLineType.LineType_Solid )
Annotation1.SetArrowHeadStyle( vi.PLineCapType.LineCapType_3DTetrahedron )

#graph.SetPlotAreaColor(vi.PFillType_FillTypeSolid, [vi.MakeColor(255,255, 255)])
